...
class User(AbstractUser, BaseModel):
    ...
    auth_status = models.CharField(max_length=100, choices=AUTH_TYPE, default=NEW)
    ...
    def create_verify_code(self, verify_type):
        code = "".join([str(random.randint(0, 1000) % 10) for _ in range(4)])
...
class UserConfirmation(BaseModel):
    ...
    verify_type = models.CharField(choices=AUTH_TYPE)   
    code = models.CharField(max_length=4) 
    user = models.ForeignKey('users.User', on_delete=models.CASCADE, related_name='verifycode')
